...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('RECEIVE_IN', 'ISSUE_OUT', 'RETURN_IN', 'TRANSFER', 'MAINT_OUT', 'MAINT_IN', 'ADJUSTMENT', 'SCRAP_OUT');

-- CreateEnum
CREATE TYPE "SlipType" AS ENUM ('RECEIVE', 'ISSUE', 'RETURN', 'TRANSFER', 'MAINT');
